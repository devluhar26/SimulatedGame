...
def landing_page():
    ...
    st.write("### Footer")
    st.write("Privacy Policy | Terms of Service | Social Media Icons")
...
def macro_events_page():
    ...
    st.write("July 2024: Federal Reserve Meeting")
    st.write("August 2024: GDP Report Release")
